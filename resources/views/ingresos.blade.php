    ...
    <div class="card-header py-3">
        ...
        <div class="card-body">
          ...
          <div class="form-group row" >
                ...
                <div class="col-md-8">
                    <input id="fechaInicio" type="date" class="form-control @error('fechaInicio') is-invalid @enderror" value="{{old('fechaInicio')}}" name="fechaInicio" required autocomplete="fechaInicio">
                    @error('fechaInicio')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
...
<script type="text/javascript">
    ...
    function filtrar(){
        document.form1.action = '{{ route('reporteIngresos') }}'; 
            document.form1.submit();   
    }

    function filtrarPdf(){
        document.form1.action = '{{ route('reporteIngresos.pdf') }}'; 
            document.form1.submit();   
    }
